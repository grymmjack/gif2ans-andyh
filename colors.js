...
function toOkLab(lrgb) {
    const l = Math.cbrt(0.4122214708 * lrgb.r + 0.5363325363 * lrgb.g + 0.0514459929 * lrgb.b);
    const m = Math.cbrt(0.2119034982 * lrgb.r + 0.6806995451 * lrgb.g + 0.1073969566 * lrgb.b);
    const s = Math.cbrt(0.0883024619 * lrgb.r + 0.2817188376 * lrgb.g + 0.6299787005 * lrgb.b);
    return new Lab(0.2104542553 * l + 0.793617785 * m - 0.0040720468 * s, 1.9779984951 * l - 2.428592205 * m + 0.4505937099 * s, 0.0259040371 * l + 0.7827717662 * m - 0.808675766 * s);
}
function okLabtoLrgb(lab) {
    const l = Math.pow(lab.l + 0.3963377774 * lab.a + 0.2158037573 * lab.b, 3.0);
    const m = Math.pow(lab.l - 0.1055613458 * lab.a - 0.0638541728 * lab.b, 3.0);
