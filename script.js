import { CGAPalette } from './colors.js';
...
const columns = 33;
const rows = Math.floor(source.height / (font.height / font.width) / (source.width / columns));
...
for (const section of sections) {
    ...
    ctx.putImageData(glyph.imageData, section.column * font.width, section.row * font.height);
